...
export const TAG = '#EXT-X-I-FRAMES-ONLY' as const;
export const EXT_X_I_FRAMES_ONLY_STRING = z.templateLiteral([TAG]);
...
export const EXT_X_I_FRAMES_ONLY_CODEC = z.codec(
    EXT_X_I_FRAMES_ONLY_STRING,
    EXT_X_I_FRAMES_ONLY_OBJECT,
    {
        decode: () => {
...
export type EXT_X_I_FRAMES_ONLY_STRING_TYPE = '#EXT-X-I-FRAMES-ONLY';
