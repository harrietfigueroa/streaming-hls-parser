...
// Error interfaces
export interface ExtXStreamInfValidationError extends ValidationError {
  type: 'ExtXStreamInfBandwidthRequiredError' | 'ExtXStreamInfBandwidthNotANumberError' |
  'ExtXStreamInfBandwidthNotAnIntegerError' | 'ExtXStreamInfBandwidthNegativeValueError' |
  'ExtXStreamInfHdcpLevelInvalidError';
}

export interface ExtXStreamInfValidationResult {
  tagName: '#EXT-X-STREAM-INF';
  errors: ExtXStreamInfValidationError[];
  isValid: boolean;
}

export type ExtXStreamInfValidationErrorUnion = ExtXStreamInfValidationError;

// Concrete error classes
export class ExtXStreamInfBandwidthRequiredError extends Error implements ExtXStreamInfValidationError {
  readonly type = 'ExtXStreamInfBandwidthRequiredError';
  readonly description = 'BANDWIDTH is required according to RFC 8216 Section 4.3.4.2.4';

  constructor(public readonly invalidValue: any) {
    super('BANDWIDTH is required');
    this.name = 'ExtXStreamInfBandwidthRequiredError';
  }
}

export class ExtXStreamInfBandwidthNotANumberError extends Error implements ExtXStreamInfValidationError {
  readonly type = 'ExtXStreamInfBandwidthNotANumberError';
  readonly description = 'BANDWIDTH must be a number according to RFC 8216 Section 4.3.4.2.4';

  constructor(public readonly invalidValue: any) {
    super('BANDWIDTH must be a number');
    this.name = 'ExtXStreamInfBandwidthNotANumberError';
  }
}

export class ExtXStreamInfBandwidthNotAnIntegerError extends Error implements ExtXStreamInfValidationError {
  readonly type = 'ExtXStreamInfBandwidthNotAnIntegerError';
  readonly description = 'BANDWIDTH must be an integer according to RFC 8216 Section 4.3.4.2.4';

  constructor(public readonly invalidValue: any) {
    super('BANDWIDTH must be an integer');
    this.name = 'ExtXStreamInfBandwidthNotAnIntegerError';
  }
}

export class ExtXStreamInfBandwidthNegativeValueError extends Error implements ExtXStreamInfValidationError {
  readonly type = 'ExtXStreamInfBandwidthNegativeValueError';
  readonly description = 'BANDWIDTH must be non-negative according to RFC 8216 Section 4.3.4.2.4';

  constructor(public readonly invalidValue: any) {
    super('BANDWIDTH must be non-negative');
    this.name = 'ExtXStreamInfBandwidthNegativeValueError';
  }
}

export class ExtXStreamInfHdcpLevelInvalidError extends Error implements ExtXStreamInfValidationError {
  readonly type = 'ExtXStreamInfHdcpLevelInvalidError';
  readonly description = 'HDCP-LEVEL must be one of: TYPE-0, NONE according to RFC 8216 Section 4.3.4.2.4';

  constructor(public readonly invalidValue: any) {
    super('HDCP-LEVEL must be one of: TYPE-0, NONE');
    this.name = 'ExtXStreamInfHdcpLevelInvalidError';
  }
} 