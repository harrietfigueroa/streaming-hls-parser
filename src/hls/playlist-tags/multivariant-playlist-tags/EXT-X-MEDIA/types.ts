...
// Error interfaces
export interface ExtXMediaValidationError extends ValidationError {
  type: 'ExtXMediaTypeRequiredError' | 'ExtXMediaUriNotAllowedError' | 'ExtXMediaGroupIdRequiredError' |
  'ExtXMediaNameRequiredError' | 'ExtXMediaAutoselectRequiredError' | 'ExtXMediaForcedNotAllowedError' |
  'ExtXMediaInstreamIdRequiredError' | 'ExtXMediaInstreamIdInvalidError' | 'ExtXMediaInstreamIdNotAllowedError';
}

export interface ExtXMediaValidationResult {
  tagName: '#EXT-X-MEDIA';
  errors: ExtXMediaValidationError[];
  isValid: boolean;
}

export type ExtXMediaValidationErrorUnion = ExtXMediaValidationError;

// Concrete error classes
export class ExtXMediaTypeRequiredError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaTypeRequiredError';
  readonly description = 'TYPE is required according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('TYPE is required');
    this.name = 'ExtXMediaTypeRequiredError';
  }
}

export class ExtXMediaUriNotAllowedError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaUriNotAllowedError';
  readonly description = 'URI must not be present when TYPE is CLOSED-CAPTIONS according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('URI must not be present when TYPE is CLOSED-CAPTIONS');
    this.name = 'ExtXMediaUriNotAllowedError';
  }
}

export class ExtXMediaGroupIdRequiredError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaGroupIdRequiredError';
  readonly description = 'GROUP-ID is required according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('GROUP-ID is required');
    this.name = 'ExtXMediaGroupIdRequiredError';
  }
}

export class ExtXMediaNameRequiredError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaNameRequiredError';
  readonly description = 'NAME is required according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('NAME is required');
    this.name = 'ExtXMediaNameRequiredError';
  }
}

export class ExtXMediaAutoselectRequiredError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaAutoselectRequiredError';
  readonly description = 'AUTOSELECT must be YES if DEFAULT is YES according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('AUTOSELECT must be YES if DEFAULT is YES');
    this.name = 'ExtXMediaAutoselectRequiredError';
  }
}

export class ExtXMediaForcedNotAllowedError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaForcedNotAllowedError';
  readonly description = 'FORCED must not be present unless TYPE is SUBTITLES according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('FORCED must not be present unless TYPE is SUBTITLES');
    this.name = 'ExtXMediaForcedNotAllowedError';
  }
}

export class ExtXMediaInstreamIdRequiredError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaInstreamIdRequiredError';
  readonly description = 'INSTREAM-ID is required when TYPE is CLOSED-CAPTIONS according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('INSTREAM-ID is required when TYPE is CLOSED-CAPTIONS');
    this.name = 'ExtXMediaInstreamIdRequiredError';
  }
}

export class ExtXMediaInstreamIdInvalidError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaInstreamIdInvalidError';
  readonly description = 'INSTREAM-ID must be one of "CC1", "CC2", "CC3", "CC4", or "SERVICEn" where n is an integer between 1 and 63 according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('INSTREAM-ID must be one of "CC1", "CC2", "CC3", "CC4", or "SERVICEn" where n is an integer between 1 and 63');
    this.name = 'ExtXMediaInstreamIdInvalidError';
  }
}

export class ExtXMediaInstreamIdNotAllowedError extends Error implements ExtXMediaValidationError {
  readonly type = 'ExtXMediaInstreamIdNotAllowedError';
  readonly description = 'INSTREAM-ID must not be specified unless TYPE is CLOSED-CAPTIONS according to RFC 8216 Section 4.3.4.2.1';

  constructor(public readonly invalidValue: any) {
    super('INSTREAM-ID must not be specified unless TYPE is CLOSED-CAPTIONS');
    this.name = 'ExtXMediaInstreamIdNotAllowedError';
  }
}
